    ...
    getTotalInfo(lat, long, date, time) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let predictinfo = yield DustPredictModel.find({ informCode: "PM25" }, { dataTime: 1, informData: 1, informGrade: 1, _id: 0 }).sort({ dataTime: -1 }).limit(3);
                ...
                // 저장된 데이터중 가장 최신의 데이터를 전달
                let dustinfo = yield DustInfoModel.find({ locName: locData.location }, { pm10Value: 1, pm25Value: 1, dataTime: 1, _id: 0 }).sort({ dataTime: -1 }).limit(1);
